% Its just a demo, you can change the name of input .txt FILENAME_MAX
...
colors = [
    0.937, 0.505, 0.513;    % blue
    0.984,0.706,0.365;    % red
   0.643,0.851,0.733;    % green
   0.412,0.619,0.831;    % yellow
    0.722,0.55,0.753;    % blue-green
];
